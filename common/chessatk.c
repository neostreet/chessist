...
int player_is_in_check(bool bBlack,unsigned char *board,int curr_move)
{
  int n;
  int movers_king;
  ...
  return count_opponent_pieces_attacking_square(movers_king_square,bBlack,board,curr_move);
}
