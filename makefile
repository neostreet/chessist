chessist: chessist.o chessdbg.o chessmsc.o chessmvs.o chessrd.o bitfuns.o chessist.res
	g++ -mwindows -g -L"/cygdrive/c/Program Files (x86)/Windows Kits/8.0/Lib/win8/um/x86" -o chessist chessist.o chessmsc.o chessdbg.o chessmvs.o chessrd.o bitfuns.o chessist.res -lGdi32 -lcurses -lComDlg32 -lComCtl32
